...
| 形状 | `S` | 矩形、圆形、三角形、五角星、箭头、菱形、平行四边形、五边形等 |
| 调色 | — | 效果图预览的滤镜预设 + 亮度 / 对比度 / 饱和度 / 色相 / 模糊参数调整 |
...
| 版本 | 日期 | 要点 |
|------|------|------|
| 2.5.0 | 2026-09-13 | 调色预设改为效果图卡片，按图片比例显示当前图层调色效果、名称叠于图片下方；新增贴纸功能、按 P 打开贴纸面板、优化侧栏属性面板选项排列 |
